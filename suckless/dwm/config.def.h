...
static const char *exitHelper[] = { "exithelper", "NULL" };
static const char *projectOpen[] = { "prop", "NULL"};
static const char *ff3sh[] = { "/lib/firefox/firefox.sh", "-P", "3sh", NULL };
static const char *ffcodes[] = { "/lib/firefox/firefox.sh", "-P", "codes", NULL };
static const char *vivaldi[] = { "vivaldi-stable",  NULL };
// screenshot
static const char *areaClip[] = { "clipScreen", NULL };
...
static const char col_ggrn[]        = "#b8bb26";


static const char *colors[][3]      = {
	/*               fg         bg         border   */
	[SchemeNorm] = { col_gray3, col_gray1, col_black },
	[SchemeSel]  = { col_gray1, col_ggrn,  col_gray3  },
...
static const Key keys[] = {
	...
	{ MODKEY|ShiftMask,             XK_q,                          spawn,              { .v = exitHelper} },
	{ MODKEY|ShiftMask,             XK_r,                          quit,               {1} }, 
    { MODKEY,                       XK_p,                          spawn,              { .v = projectOpen } },
    ...
    { MODKEY|ShiftMask,             XK_b,                          spawn,              { .v = vivaldi } },
    { MODKEY|ShiftMask,             XK_c,                          spawn,              { .v = vivaldi } },
    { MODKEY|ShiftMask,             XK_v,                          spawn,              { .v = areaClip }},
	TAGKEYS(                        XK_1,                          0)
	TAGKEYS(                        XK_2,                          1)
	TAGKEYS(                        XK_3,                          2)
	TAGKEYS(                        XK_4,                          3)
